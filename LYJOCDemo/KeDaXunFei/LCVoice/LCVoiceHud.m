...
- (id)init
{
    ...
    self = [super initWithFrame:ApplicationDelegate.window.bounds];
...
-(void) createMainUI{
    ...
    CGRect frame1 = CGRectMake(0, 44-44, ScreenWidth, ScreenHeight+44);
    CGRect frame2 = CGRectMake(ScreenWidth/2-164/2, 200, 179, 179);
    ...
    backBlackImageView.image = [UIImage imageNamed:@"black_bg_ip5.png"]; //_IMAGE_UNDER;
    ...
    _dynamicProgress.image = [UIImage imageNamed:@"mic_talk_358x358.png"];
